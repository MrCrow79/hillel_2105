...
class TestAPIClient(unittest.TestCase):
    ...
    def test_get_data_success(self, mock_get):
        ...
        # підготовка несправжньої відповіді
        ...
        result = api_client.get_data()  # send request to https://api.example.com/data Який перехзопив Mock
    ...
    def test_get_data_failure(self, mock_get):
        ...
        api_client = APIClient(base_url='https://api.example.com')
        result = api_client.get_data()  # send request to https://api.example.com/data
